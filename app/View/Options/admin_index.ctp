...
<div class="row">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink('<i class="glyphicon glyphicon-trash"></i>', array('action' => 'delete', $option['Option']['id']), array('escape' => false,'title'=>'Xoá'), __('Are you sure you want to delete # %s?', $option['Option']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
