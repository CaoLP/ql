...
<div class="row">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link('<i class="glyphicon glyphicon-folder-open"></i>', array('action' => 'view', $optionGroup['OptionGroup']['id']), array('escape' => false,'title'=>'Xem thông tin')); ?>
			<?php echo $this->Html->link('<i class="glyphicon glyphicon-edit"></i>', array('action' => 'edit', $optionGroup['OptionGroup']['id']), array('escape' => false,'title'=>'Thay đổi thông tin')); ?>
			<?php echo $this->Form->postLink('<i class="glyphicon glyphicon-trash"></i>', array('action' => 'delete', $optionGroup['OptionGroup']['id']), array('escape' => false,'title'=>'Xoá'), __('Are you sure you want to delete # %s?', $optionGroup['OptionGroup']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
