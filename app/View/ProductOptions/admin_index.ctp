<div class="productOptions index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('price_increment'); ?></th>
	...
	<tr>
		<td><?php echo h($productOption['ProductOption']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($productOption['ProductOption']['price_increment']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $productOption['ProductOption']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $productOption['ProductOption']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $productOption['ProductOption']['id']), array(), __('Are you sure you want to delete # %s?', $productOption['ProductOption']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
