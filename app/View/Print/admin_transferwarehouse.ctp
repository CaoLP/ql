    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="9" class="text-center">
                <span class="title">PHIẾU CHUYỂN HÀNG</span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"><strong>Kho xuất: </strong></td><td colspan="7"><?php echo $data['Store']['name']; ?></td>
        </tr>
        <tr>
            <td colspan="2"><strong>Kho nhận: </strong></td><td colspan="7"><?php echo $data['ReceiveStore']['name']; ?></td>
        </tr>
        <tr>
            <td colspan="2"><strong>Ngày nhận: </strong></td><td colspan="7"><?php echo date('\N\g\à\y d \t\h\á\n\g m \n\ă\m Y',strtotime($data['InoutWarehouse']['tranfered'])); ?></td>
        </tr>
        <tr>
            <td colspan="9"></td>
        </tr>
