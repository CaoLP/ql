...
if ($this->request->params['action'] == 'add') {
	$this->Html->addCrumb ('<li>Tạo mới quyền</li>', '/'.$this->request->url, array ('escape' => false));
} else {
	$this->Html->addCrumb ('<li>' . $this->request->data['Role']['name'] . '</li>', '/'.$this->request->url, array ('escape' => false));
}
?>
		...
		<div class="row">
			<div class="widget">
				<div class="widget-header">
					<div class="title">
						<span class="fs1" aria-hidden="true"
							  data-icon="&#xe039;"></span> <?php echo __ ('Thông tin quyền'); ?>
					</div>
				</div>
				<div class="widget-body">
					...
					echo $this->Form->input('name',array ('label' => array ('text' => 'Tên quyền', 'class' => 'col-lg-2 control-label')));
					?>
		...
		<div class="widget">
			...
			<div class="widget-body">
				<ul class="nav nav-stacked" id="sidebar">
					<li><?php echo $this->Html->link(__('Danh sách quyền'), array('action' => 'index')); ?></li>
				</ul>
			</div>
		</div>
