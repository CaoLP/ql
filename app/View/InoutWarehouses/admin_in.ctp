				...
				<table class="table table-condensed table-bordered table-hover no-margin">
					...
					<?php foreach ($inoutWarehouses as $inoutWarehouse): ?>
						<tr>
							...
							<td class="actions">
								<?php echo $this->Html->link('<i class="glyphicon glyphicon-folder-open"></i>', array('action' => 'view',    $inoutWarehouse['InoutWarehouse']['id'],'in'), array('escape' => false,'title'=>'Xem thông tin')); ?>
							</td>
						</tr>
					<?php endforeach; ?>
