                    ...
                    <ul class="list-group no-margin">
                        <li class="list-group-item">
                            <div class="input-group input-group-sm">
                                ...
                                ?>
                                <input id="input-customer" readonly class="form-control" placeholder="Tìm khách hàng (F7)" value="<?php
...
<!--                        </li>-->
                ...
                <div class="tab-pane fade in active" id="info-total">
                    <ul class="list-group no-margin">
                        ...
                        <li class="list-group-item"
                            ...
                            <div class="input-group input-group-sm">
                                <span class="input-group-addon">Đã nhận(F8)</span>
                                <?php
        ...
        <div class="right-block">
            ...
            <div class="text-center bt-done">
                <div class="btn-group">
                    ...
                    <?php
                    echo '<button type="submit" class="btn btn-success" id="save">Thanh toán(F9)</button>';
                    ?>
                </div>
            </div>
        </div>
    ...
    <div class="div-left">
        <div class="kv2List">
            <div class="kv2ListScroll" id="order-product">
                <?php
        ...
        <div class="kv2Pro" id="panel-from-left">
            <a href="javascript:;" class="btn-expand" title="Tìm nhanh">
                <span>>>><i class="icon icon-arrow-up"></i><<<</span>
            </a>
