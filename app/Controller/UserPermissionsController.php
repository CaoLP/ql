...
class UserPermissionsController extends AppController {
	...
	public $uses = array('Aco');
	public $title_for_layout = 'Quyền truy cập';

    public function  beforeFilter() {
        parent::beforeFilter();
		$this->Auth->allow('admin_sync','admin_index');
...
//        $Aco_sync();
    ...
    public function admin_edit($acoId) {
        $this->layout = "ajax";
        $acoPath = $this->Aco->getPath($acoId);
