 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guHANKbWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309300353542496749683645');
...
Configure::write('point_cal',10000);